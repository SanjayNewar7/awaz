...
public class AllPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeLayout.setOnClickListener(v -> {
            Intent intent = new Intent(AllPostActivity.this, HomeMainActivity.class);
            startActivity(intent);
        });

        raiseIssueLayout.setOnClickListener(v -> {
            Intent intent = new Intent(AllPostActivity.this, RaiseIssueActivity.class);
            startActivity(intent);
        });

        filterLayout.setOnClickListener(v -> {
            Intent intent = new Intent(AllPostActivity.this, FilterActivity.class);
            startActivity(intent);
        });

        myReportLayout.setOnClickListener(v -> {
            Intent intent = new Intent(AllPostActivity.this, MyReportActivity.class);
            startActivity(intent);
        });
        ...
        tabNearby.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AllPostActivity.this, TrendingActivity.class);
                startActivity(intent);
            }
        });
        ...
        tabAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Start AllSettingActivity
                Intent intent = new Intent(AllPostActivity.this, AllPostActivity.class);
                startActivity(intent);
            }
        });
        ...
        profileIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Start AllSettingActivity
                Intent intent = new Intent(AllPostActivity.this, ProfileActivity.class);
                startActivity(intent);
            }
        });
        ...
        settingLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AllPostActivity.this, AllSettingActivity.class);
                startActivity(intent);
            }
        });
        ...
        for (int i = 0; i < postsContainer.getChildCount(); i++) {
            ...
            postView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(AllPostActivity.this, ItemPostDetailActivity.class);
